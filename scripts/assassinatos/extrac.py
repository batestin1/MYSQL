...
class Extrac():
    def __init__(self):
        #extract
        self.dados = spark.read.csv("../../dataset/murder_2015_final.csv", header= True, inferSchema=True)
        self.dados2 = spark.read.csv("../../dataset/murder_2016_prelim.csv", header=True, inferSchema=True)
