...
conf = pyspark.SparkConf().setAppName('assassinato').setMaster('local')
...
class Extrac():
    def __init__(self):
        #extract
        self.dados = sql_c.read.csv("../../dataset/murder_2015_final.csv", header= True, inferSchema=True)
        self.dados2 = sql_c.read.csv("../../dataset/murder_2016_prelim.csv", header=True, inferSchema=True)
