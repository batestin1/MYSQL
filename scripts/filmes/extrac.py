...
class Extrac():
    def __init__(self):
        self.dados = spark.read.csv("../../dataset/fandango_score_comparison.csv", header= True, inferSchema=True, encoding='cp1252')
        self.dados2 = spark.read.csv("../../dataset/fandango_scrape.csv", header= True, inferSchema=True, encoding='cp1252')
