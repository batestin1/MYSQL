...
class Extrac():
    def __init__(self):
        self.dados = spark.read.csv("../../dataset/Characters.csv", sep=';', header= True, inferSchema=True, encoding='UTF-8')
        self.dados2 = spark.read.csv("../../dataset/Potions.csv", sep=';', header=True, inferSchema=True, encoding='UTF-8')
        self.dados3 = spark.read.csv("../../dataset/Spells.csv", sep=';', header=True, inferSchema=True, encoding='UTF-8')
