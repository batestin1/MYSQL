...
class Extrac():
    def __init__(self):
        self.dados = spark.read.csv("../../dataset/dc-wikia-data.csv", sep=',', header= True, inferSchema=True, encoding='UTF-8')
        self.dados2 = spark.read.csv("../../dataset/marvel.csv", sep=',', header=True, inferSchema=True, encoding='UTF-8')
