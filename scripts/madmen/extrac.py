...
class Extrac():
    def __init__(self):
        self.dados = spark.read.csv("../../dataset/performer-scores.csv", sep=',', header= True, inferSchema=True, encoding="cp1252")
        self.dados2 = spark.read.csv("../../dataset/show-data.csv", sep=',', header=True, inferSchema=True,
                                     encoding="cp1252")
