...
class Extrac():
    def __init__(self):
        self.dados = spark.read.csv("../../dataset/noc_regions.csv", sep=',', header= True, inferSchema=True, encoding='UTF-8')
        self.dados2 = spark.read.csv("../../dataset/olimpiadas.csv", sep=',', header=True, inferSchema=True, encoding='UTF-8')
