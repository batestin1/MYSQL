...
class Extrac():
    def __init__(self):
        self.dados = spark.read.csv("../../dataset/simpsons_characters.csv",
                                    sep=',', header=True,
                                    inferSchema=True,
                                    encoding='UTF-8')
        self.dados2 = spark.read.csv("../../dataset/simpsons_episodes.csv",
                                    sep=',', header=True,
                                    inferSchema=True,
                                    encoding='UTF-8')
        self.dados3 = spark.read.csv("../../dataset/simpsons_locations.csv",
                                     sep=',', header=True,
                                     inferSchema=True,
                                     encoding='UTF-8')
